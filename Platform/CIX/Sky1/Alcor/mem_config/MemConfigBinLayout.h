...
extern MEM_CONFIG_BLOCK_CONFIG      GlobalConfigBlock_alcor_4g;
extern MEM_CONFIG_BLOCK_CONFIG      GlobalConfigBlock_alcor_8g;
extern MEM_CONFIG_BLOCK_CONFIG      GlobalConfigBlock_alcor_16g;
...
#define CDCB_BLOCK_LIST \
  ...
  CDCB_BLOCK(GlobalConfigBlock_alcor_4g), \
  CDCB_BLOCK(GlobalConfigBlock_alcor_8g), \
  CDCB_BLOCK(GlobalConfigBlock_alcor_16g), \
