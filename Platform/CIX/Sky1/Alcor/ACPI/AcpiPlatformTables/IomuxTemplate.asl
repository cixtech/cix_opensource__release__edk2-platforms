 ...
 */
 ...
 Device (MUX0) {
   ...
   Name (_CRS, ResourceTemplate () {
     ...
     PinGroup ("pinctrl_fch_i2c7", ResourceProducer, ,
         RawDataBuffer ()
         {
 ...
 //        }
    ...
    PinGroup ("pinctrl_gpio_dp3_sbu_aux", ResourceProducer, ,
         RawDataBuffer ()
         {
            CIX_PAD_GPIO045_FUNC_GPIO045(PULL_DOWN|DS_LEVEL4),
         })
         {
            CIX_PAD_GPIO045,
         }

     PinGroup ("pinctrl_gpio_dp4_sbu_aux", ResourceProducer, ,
         RawDataBuffer ()
         {
            CIX_PAD_GPIO046_FUNC_GPIO046(PULL_DOWN|DS_LEVEL4),
         })
         {
            CIX_PAD_GPIO046,
         }
 ...
 Device (MUX1) {
   ...
   Name (_CRS, ResourceTemplate () {
    ...
    PinGroup ("pinctrl_usbc2_vbus_pwr", ResourceProducer, ,
         RawDataBuffer ()
         {
     ...
     PinGroup ("pinctrl_usbc3_vbus_pwr", ResourceProducer, ,
         RawDataBuffer ()
         {
     ...
     PinGroup ("pinctrl_usbc2_pd_int", ResourceProducer, ,
         RawDataBuffer ()
         {
            CIX_PAD_GPIO008_FUNC_GPIO008(PULL_UP|DS_LEVEL4),
         })
         {
            CIX_PAD_GPIO008,
         }

     PinGroup ("pinctrl_usbc3_pd_int", ResourceProducer, ,
         RawDataBuffer ()
         {
