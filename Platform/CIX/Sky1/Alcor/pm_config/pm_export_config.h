...
/* pm-config current supported version (v3.4) */
#define PM_CONFIG_VERSION_MAJOR  3
#define PM_CONFIG_VERSION_MINOR  4
...
#define PM_OP_MODE_PERFORMANCE  0
#define PM_OP_MODE_LOW_POWER    1
#define PM_OP_MODE_MAX          2
...
typedef struct {
    ...
    pm_config_log_uart_t    log_config;
    ...
    config_data_t           op_mode;
    config_data_t           psi7_mode;
