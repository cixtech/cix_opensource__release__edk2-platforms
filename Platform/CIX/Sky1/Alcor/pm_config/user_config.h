...
#endif
#if PM_LOG_CONFIG
#define LOG_OVER_UART_ENABLE_MAGIC  0x2DBA0C1D
#define UART_STRICT_FORBID_MAGIC    0x2DBA0C1E
static pm_config_log_uart_t log_config = {
    .log_enable = {
        .fields = {
            .valid    = PM_CONFIG_VALID,
            .raw_data = LOG_OVER_UART_ENABLE_MAGIC,
        }
    },
    .uart_baudrate = {
        .fields = {
...
static pm_config_noc_idle_t noc_idle_config_data = {
    .noc_idle_enable = {
        .fields = {
            .valid    = PM_CONFIG_VALID,
...
#ifndef PM_OP_MODE_CONFIG
#define PM_OP_MODE_CONFIG  0
#endif
#if PM_OP_MODE_CONFIG
static config_data_t op_mode_config = {
    .fields = {
        .valid      = PM_CONFIG_VALID,
        .raw_data   = PM_OP_MODE_PERFORMANCE,
    }
};
#endif
