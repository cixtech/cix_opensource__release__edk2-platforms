...
[Defines]
  ...
  ACPI_IOMUX_INPUT               = Platform/CIX/Sky1/Alcor/ACPI/AcpiPlatformTables/IomuxTemplate.asl
...
##################################################
  ...
  DEFINE GPIO_POWER_BUTTON_ENABLE   = TRUE
...
# PlatformConfigParamsHookLib - RTC voltage drop detect + Get EC Board ID
  ...
  PinMuxTableLib|Platform/CIX/Sky1/Alcor/Library/PinMuxTableLib/PinMuxTableLib.inf
  GpioTableLib|Platform/CIX/Sky1/Alcor/Library/GpioTableLib/GpioTableLib.inf
  ...
  PlatformEnvHookLib|Platform/CIX/Sky1/Alcor/Library/PlatformEnvHookLib/PlatformEnvHookLib.inf
  RealTimeClockLib|Platform/CIX/Sky1/Alcor/Library/Ra8900ceRealTimeClockLib/Ra8900ceRealTimeClockLib.inf

  PlatformBootHookLib|Platform/CIX/Sky1/Alcor/Library/PlatformBootHookLib/PlatformBootHookLib.inf
...
!if $(ACPI_ENABLE) == TRUE
  Platform/CIX/Sky1/Alcor/ACPI/AcpiPlatformTables/AcpiPlatformTables.inf {
    <BuildOptions>
      *_*_*_ASLCC_FLAGS = -I$(WORKSPACE)/$(OUTPUT_DIRECTORY)
  }
  Platform/CIX/Sky1/Alcor/ACPI/AcpiPlatformDxe/AcpiPlatformDxe.inf
!endif
!if $(SMBIOS_ENABLE) == TRUE
  Platform/CIX/Sky1/Alcor/PlatformSmbios/PlatformSmbios.inf
!endif
...
!if $(LINUX_ACPI_CONFIG_OVERRIDE) == TRUE
  ...
  GCC:*_*_*_ASLPP_FLAGS           = -I$(WORKSPACE)/Platform/CIX/Sky1/$(PLATFORM_NAME)/ACPI
!endif
...
!endif
  gCixPlatformTokenSpaceGuid.PcdSiliconDtbUpdateFileName|L"SKY1-ALCOR.DTB"
  ...
  gCixPlatformTokenSpaceGuid.PcdPdDevCount|4
  # Refer to TYPEC_MODE enum
  gCixPlatformTokenSpaceGuid.PcdTypecPortDefaultModes|{ 1, 1, 1, 1 }# 0: disconnect, 1: usb only, 3: usb+dp 4: dp only
  # Refer to TYPEC_ORIENTATION enum
  gCixPlatformTokenSpaceGuid.PcdTypecPortDefaultOrientations|{ 1, 1, 1, 1 } # 0: none, 1: normal, 2: reverse
  gCixPlatformTokenSpaceGuid.PcdPdDevAlertPins|{ 10, 10, 0xFF, 0xFF }
  gCixPlatformTokenSpaceGuid.PcdPdDevI2cBuses|{ 0x1, 0x1, 0xFF, 0xFF } # 0xFF: not actual pd device
  gCixPlatformTokenSpaceGuid.PcdPdDevI2cSlaveAddresses|{ 0x30, 0x31, 0xFF, 0xFF }  # 0xFF: not actual pd device
  # RTC
  gCixPlatformTokenSpaceGuid.PcdRa8900ceI2cBus|3
  gCixPlatformTokenSpaceGuid.PcdRa8900ceI2cSlaveAddress|0x32
  ...
  gCixTokenSpaceGuid.PcdUsbCDrdControl0VbusDetect|TRUE
...
# ISP Camera Power
  ...
  gCixPlatformTokenSpaceGuid.PcdAcpiGpio4IoMask|0x20000000 # DEPOP_MUTE_L
